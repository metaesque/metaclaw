...
def main():
  parser = argparse.ArgumentParser(description="Parse OpenClaw GitHub releases for breaking changes.")
  parser.add_argument('-t', '--term', type=str, default='2026.3.28',
                      help="Stopping term (e.g., '2026.3.28'). Script stops when h2 contains this string.")
  ...
  for section in sections:
    ...
    if args.term in version_text:
      print(f"Termination term '{args.term}' found in {version_text}. Stopping.")
      break
  ...
  print(f"Successfully generated {output_file} with {len(content_blocks)} release blocks.")
