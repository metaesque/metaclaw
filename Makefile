...
-include $(SERVICES_DIR)/reldb/.env
-include $(SERVICES_DIR)/vectordb/.env
-include $(SERVICES_DIR)/graphdb/.env
-include $(SERVICES_DIR)/runner/.env
-include $(SERVICES_DIR)/diffusion-runner/.env
-include $(SERVICES_DIR)/speech-runner/.env
-include $(SERVICES_DIR)/acoustic-runner/.env
...
-include $(SERVICES_DIR)/ingress/.env
